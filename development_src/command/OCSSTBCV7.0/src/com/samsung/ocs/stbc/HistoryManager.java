...
import com.samsung.ocs.manager.impl.STBCHistoryManager;
...
public class HistoryManager extends AbstractOcsThread{
	...
	public HistoryManager(){
		stbcHistoryManager = STBCHistoryManager.getInstance(null, null, false, false, 0);
...
//				stbcHistoryManager.deleteSTBCHistoryFromDB(timeBefore);
//			}
			if (ocsInfoManager.isSTBCHistoryDeleteUsed()){
	...
	private static Logger exceptionLog = Logger.getLogger("STBCException");
