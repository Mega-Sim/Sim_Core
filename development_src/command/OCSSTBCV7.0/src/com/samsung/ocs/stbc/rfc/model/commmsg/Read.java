...
public class Read extends NormalCommResult {
	 ...
	 */
	public Read(byte[] recieveMessage) {
	...
	public byte[] getIdDataBytes() {
		byte[] b = new byte[64];
		System.arraycopy(recieveMessage, 273, b, 0, 64);
		return b;
	}
	...
	public String toLogString(String sourceIpAddress) {
		...
		sb.append(" STBNO [").append(getStbNumber()).append("] CARRIERDETECT[").append(getCarrierDetectByte()).append("] READRESULT[").append(getReadResultByte()).append("] IDDATA[").append(getIdData()).append("]");
		sb.append("\n");
