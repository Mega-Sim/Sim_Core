...
public class ReadAll2 extends ReadAll {

	/**
	 * Constructor of ReadAll2 class.
	 * 
	 * @param recieveMessage
	 */
	public ReadAll2(byte[] recieveMessage) {
	...
	public String getKey() {
		return String.format("%s[%s:-1]", getMachineId(), NORMAL_COMMTYPE.READALL);
	}
	...
	public String toLogString(String sourceIpAddress) {
		...
		sb.append(" DATACNT[").append(getDataCount()).append("] DATAMAX[").append(getDataMax()).append("] STBNO [").append(getStbNumber()).append("] CARRIERDETECT[").append(getCarrierDetectByte()).append("] READRESULT[").append(getReadResultByte()).append("] IDDATA[").append(getIdData()).append("] FOUPIDDATA[").append(getFoupIdData()).append("]");
		sb.append("\n");
