...
public class OcsProcessVersionDAO {
	 ...
	 */
	public static void registerVersion(DBAccessManager dbAccessManager, String hostServiceType, String moduleName, String version, String buildDate, String includeInfo) {
		Connection conn = null;
		ResultSet rs = null;
		PreparedStatement pstmt = null;
		...
		try {
			...
			if (hostServiceType.equalsIgnoreCase("Primary")) {
				...
				pstmt.setString(4, includeInfo);
				pstmt.setString(5, moduleName.toLowerCase());
				pstmt.setString(6, version);
				pstmt.setString(7, buildDate);
				pstmt.setString(8, includeInfo);
			} else {
	 ...
	 * @param hostServiceType
	 */
	public static void historyVersion(DBAccessManager dbAccessManager, String moduleName, String hostServiceType, String version, String buildDate, String includeInfo) {
		Connection conn = null;
		ResultSet rs = null;
		PreparedStatement pstmt = null;
