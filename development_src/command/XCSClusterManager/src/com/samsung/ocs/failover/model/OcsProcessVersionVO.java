...
public class OcsProcessVersionVO {
	...
	private String primary_Include_Version;
	private String primary_Update_Time;
	private String secondary_Version;
	private String secondary_Bulid_Date;
	private String secondary_Include_Version;
	private String secondary_Update_Time;
	...
	public String getPrimary_Include_Version() {
		return primary_Include_Version;
	}
	public void setPrimary_Include_Version(String primary_Include_Version) {
		this.primary_Include_Version = primary_Include_Version;
	}
	public String getPrimary_Update_Time() {
		return primary_Update_Time;
	}
	public void setPrimary_Update_Time(String primary_Update_Time) {
		this.primary_Update_Time = primary_Update_Time;
	}
	...
	public String getSecondary_Include_Version() {
		return secondary_Include_Version;
	}
	public void setSecondary_Include_Version(String secondary_Include_Version) {
		this.secondary_Include_Version = secondary_Include_Version;
	}
	public String getSecondary_Update_Time() {
		return secondary_Update_Time;
	}
	public void setSecondary_Update_Time(String secondary_Update_Time) {
		this.secondary_Update_Time = secondary_Update_Time;
	}
